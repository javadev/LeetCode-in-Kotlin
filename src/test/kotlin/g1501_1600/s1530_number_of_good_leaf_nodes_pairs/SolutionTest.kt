...
internal class SolutionTest {
    ...
    fun countPairs() {
        ...
        MatcherAssert.assertThat(Solution().countPairs(treeNode, 3), CoreMatchers.equalTo(1))
    }

    @Test
    fun countPairs2() {
        val treeNode = TreeNode.create(mutableListOf(1, 2, 3, 4, 5, 6, 7))
        MatcherAssert.assertThat(Solution().countPairs(treeNode, 3), CoreMatchers.equalTo(2))
    }
