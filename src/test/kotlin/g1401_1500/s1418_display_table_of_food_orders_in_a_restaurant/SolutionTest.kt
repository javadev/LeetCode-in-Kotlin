...
internal class SolutionTest {
    ...
    fun displayTable() {
        val orders = listOf(
            ...
            mutableListOf("Corina", "10", "Beef Burrito"), mutableListOf("David", "3", "Fried Chicken"),
            mutableListOf("Carla", "5", "Water"), mutableListOf("Carla", "5", "Ceviche"),
            mutableListOf("Rous", "3", "Ceviche")
        )
        val output = listOf(
            mutableListOf("Table", "Beef Burrito", "Ceviche", "Fried Chicken", "Water"),
            mutableListOf("3", "0", "2", "1", "0"), mutableListOf("5", "0", "1", "0", "1"),
    ...
    fun displayTable2() {
        val orders = listOf(
            ...
            mutableListOf("Ratesh", "12", "Fried Chicken"), mutableListOf("Amadeus", "12", "Fried Chicken"),
            mutableListOf("Adam", "1", "Canadian Waffles"), mutableListOf("Brianna", "1", "Canadian Waffles")
        )
        val output = listOf(
            mutableListOf("Table", "Canadian Waffles", "Fried Chicken"),
            mutableListOf("1", "2", "0"), mutableListOf("12", "0", "3")
        )
        assertThat(Solution().displayTable(orders), equalTo(output))
    }
    ...
    fun displayTable3() {
        val orders = listOf(
            ...
            mutableListOf("Jhon", "2", "Beef Burrito"), mutableListOf("Melissa", "2", "Soda")
        )
        val output = listOf(
