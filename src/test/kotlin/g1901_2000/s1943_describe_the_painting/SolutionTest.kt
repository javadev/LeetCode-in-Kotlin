...
internal class SolutionTest {
    ...
    fun splitPainting2() {
        assertThat(
            ...
            equalTo(
                listOf(
                    mutableListOf(1L, 6L, 9L), mutableListOf(6L, 7L, 24L),
                    mutableListOf(7L, 8L, 15L), mutableListOf(8L, 10L, 7L)
                )
            )
        )
    }
    ...
    fun splitPainting3() {
        assertThat(
            Solution()
                .splitPainting(
                    arrayOf(
                        intArrayOf(1, 4, 5), intArrayOf(1, 4, 7),
                        intArrayOf(4, 7, 1), intArrayOf(4, 7, 11)
                    )
                ),
