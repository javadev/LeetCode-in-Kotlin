...
internal class SolutionTest {
    ...
    fun countDaysTogether3() {
        assertThat(
            Solution().countDaysTogether("09-01", "10-19", "06-19", "10-20"),
            equalTo(49),
        )
    }
    ...
    fun countDaysTogether4() {
        assertThat(
            Solution().countDaysTogether("08-06", "12-08", "02-04", "09-01"),
            equalTo(27),
        )
    }
    ...
    fun countDaysTogether5() {
        assertThat(
            Solution().countDaysTogether("03-05", "07-14", "04-14", "09-21"),
            equalTo(92),
        )
    }
}
