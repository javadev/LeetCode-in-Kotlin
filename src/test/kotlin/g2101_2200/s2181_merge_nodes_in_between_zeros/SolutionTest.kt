...
internal class SolutionTest {
    ...
    fun mergeNodes() {
        ...
        MatcherAssert.assertThat(Solution().mergeNodes(head).toString(), CoreMatchers.equalTo("4, 11"))
    }

    @Test
    fun mergeNodes2() {
        val head = createSinglyLinkedList(mutableListOf(0, 1, 0, 3, 0, 2, 2, 0))
        MatcherAssert.assertThat(Solution().mergeNodes(head).toString(), CoreMatchers.equalTo("1, 3, 4"))
    }
}
